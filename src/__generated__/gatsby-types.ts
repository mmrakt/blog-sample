...
type ContentfulPost = ContentfulReference & ContentfulEntry & Node & {
  ...
  /**
   * Returns the first child node of type contentfulPostExcerptTextNode or null if
  ...
  /**
   * Returns the first child node of type contentfulPostContentTextNode or null if
   * there are no children of given type on this node
   */
...
type ContentfulPostFieldsEnum =
  ...
  | 'coverImage.fixed.srcWebp'
  | 'coverImage.fixed.srcSetWebp'
  ...
  | 'coverImage.sizes.srcWebp'
  | 'coverImage.sizes.srcSetWebp'
  | 'coverImage.sizes.sizes'
  | 'coverImage.gatsbyImageData'
  | 'coverImage.resize.base64'
  | 'coverImage.resize.tracedSVG'
  | 'coverImage.resize.src'
  | 'coverImage.resize.width'
  | 'coverImage.resize.height'
  | 'coverImage.resize.aspectRatio'
...
type ContentfulTagFieldsEnum =
  ...
  | 'post.coverImage.fixed.base64'
  | 'post.coverImage.fixed.tracedSVG'
  | 'post.coverImage.fixed.aspectRatio'
  | 'post.coverImage.fixed.width'
  | 'post.coverImage.fixed.height'
  | 'post.coverImage.fixed.src'
  | 'post.coverImage.fixed.srcSet'
  | 'post.coverImage.fixed.srcWebp'
  | 'post.coverImage.fixed.srcSetWebp'
  | 'post.coverImage.resolutions.base64'
  | 'post.coverImage.resolutions.tracedSVG'
  | 'post.coverImage.resolutions.aspectRatio'
  | 'post.coverImage.resolutions.width'
  | 'post.coverImage.resolutions.height'
  | 'post.coverImage.resolutions.src'
  | 'post.coverImage.resolutions.srcSet'
  | 'post.coverImage.resolutions.srcWebp'
  | 'post.coverImage.resolutions.srcSetWebp'
  | 'post.coverImage.fluid.base64'
  | 'post.coverImage.fluid.tracedSVG'
  | 'post.coverImage.fluid.aspectRatio'
  | 'post.coverImage.fluid.src'
  | 'post.coverImage.fluid.srcSet'
  | 'post.coverImage.fluid.srcWebp'
  | 'post.coverImage.fluid.srcSetWebp'
  | 'post.coverImage.fluid.sizes'
  | 'post.coverImage.sizes.base64'
  | 'post.coverImage.sizes.tracedSVG'
  | 'post.coverImage.sizes.aspectRatio'
  | 'post.coverImage.sizes.src'
  | 'post.coverImage.sizes.srcSet'
  | 'post.coverImage.sizes.srcWebp'
  | 'post.coverImage.sizes.srcSetWebp'
  | 'post.coverImage.sizes.sizes'
  | 'post.coverImage.gatsbyImageData'
  | 'post.coverImage.resize.base64'
  | 'post.coverImage.resize.tracedSVG'
  | 'post.coverImage.resize.src'
  | 'post.coverImage.resize.width'
  | 'post.coverImage.resize.height'
  | 'post.coverImage.resize.aspectRatio'
...
type SitePluginFieldsEnum =
  ...
  | 'pluginOptions.plugins.pluginOptions.spaceId'
  | 'pluginOptions.plugins.pluginOptions.accessToken'
  | 'pluginOptions.plugins.pluginOptions.host'
  | 'pluginOptions.plugins.pluginOptions.environment'
  | 'pluginOptions.plugins.pluginOptions.downloadLocal'
  | 'pluginOptions.plugins.pluginOptions.forceFullSync'
  | 'pluginOptions.plugins.pluginOptions.pageLimit'
  | 'pluginOptions.plugins.pluginOptions.assetDownloadWorkers'
  | 'pluginOptions.plugins.pluginOptions.useNameForId'
...
type BlogRollQueryQueryVariables = Exact<{
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
}>;


type BlogRollQueryQuery = { readonly allContentfulPost: { readonly nodes: ReadonlyArray<(
...
type SiteMetaQueryQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description'>> }> };
...
type BlogPostByIDQuery = { readonly contentfulPost: Maybe<(
    Pick<ContentfulPost, 'date' | 'slug' | 'title'>
    & { readonly content: Maybe<{ readonly childMarkdownRemark: Maybe<Pick<MarkdownRemark, 'html'>> }>, readonly tags: Maybe<ReadonlyArray<Maybe<Pick<ContentfulTag, 'title' | 'slug'>>>>, readonly coverImage: Maybe<Pick<ContentfulAsset, 'gatsbyImageData'>> }
  )> };
